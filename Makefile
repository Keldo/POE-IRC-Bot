# This Makefile is for the Rictus-Bot extension to perl.
#
...
#     BUILD_REQUIRES => { POE=>q[1.366], POE::Component::IRC=>q[6.88], Config-Simple=>q[4.59] }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Rictus-Bot]
#     PREREQ_PM => { POE=>q[1.366], POE::Component::IRC=>q[6.88], Config-Simple=>q[4.59] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/POE/Component/IRC/Plugin/Rictus.pm]
...
TO_INST_PM = lib/POE/Component/IRC/Plugin/IRCDHelp.pm \
	lib/POE/Component/IRC/Plugin/Rictus.pm

PM_TO_BLIB = lib/POE/Component/IRC/Plugin/IRCDHelp.pm \
	blib\lib\POE\Component\IRC\Plugin\IRCDHelp.pm \
	lib/POE/Component/IRC/Plugin/Rictus.pm \
	blib\lib\POE\Component\IRC\Plugin\Rictus.pm
...
Bot.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Rictus-Bot\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "  POE: '1.366'" >> META_new.yml
	$(NOECHO) $(ECHO) "  POE::Component::IRC: '6.88'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Rictus-Bot" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Rictus-Bot\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "            \"POE\" : \"1.366\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"POE::Component::IRC\" : \"6.88\"" >> META_new.json
	$(NOECHO) $(ECHO) "         }}" >> META_new.json
	$(NOECHO) $(ECHO) "      }}," >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/POE/Component/IRC/Plugin/IRCDHelp.pm blib\lib\POE\Component\IRC\Plugin\IRCDHelp.pm \
	  lib/POE/Component/IRC/Plugin/Rictus.pm blib\lib\POE\Component\IRC\Plugin\Rictus.pm 
